...
local function get_groups()
  ...
  local groups = {
    ...
    WinBar = { fg = colors.fg3, bg = colors.bg1 },
    ...
    FoldColumn = config.transparent_mode and { fg = colors.gray, bg = nil } or { fg = colors.bg2, bg = nil },
    ...
    MiniCursorword = { fg = nil, bg = nil, italic = true, bold = true },
    MiniCursorwordCurrent = { fg = nil, bg = nil, underline = false, bold = true },
    --- FzfLua
